...
apt-get -qq -y install busybox-static axel gdisk zsync util-linux btrfs-tools btrfs-progs dosfstools grub-common grub2-common grub-efi-amd64 grub-efi-amd64-bin > /dev/null
